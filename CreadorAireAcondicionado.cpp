...
CreadorAireAcondicionado::CreadorAireAcondicionado() : CreadorEquipos("AireAcondicionado"){

}

Equipo * CreadorAireAcondicionado::crearEquipos(const string &linea) {
    ...
    AireAcondicionado* aireAcondicionado = new AireAcondicionado(id, nombre, criticidad, enUso, incidenciasActivas, tiempoInactivo);
