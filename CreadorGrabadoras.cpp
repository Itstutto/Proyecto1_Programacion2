...
CreadorGrabadoras::CreadorGrabadoras() : CreadorEquipos("Grabadora"){
}

Equipo * CreadorGrabadoras::crearEquipos(const string &linea) {
    ...
    Grabadoras* grabadora = new Grabadoras(id, nombre, criticidad, enUso, incidenciasActivas, tiempoInactivo);
