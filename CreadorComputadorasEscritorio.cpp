...
Equipo * CreadorComputadorasEscritorio::crearEquipos(const string &linea) {
    ...
    ComputadorasEscritorio* computadoraEscritorio = new ComputadorasEscritorio(id, nombre, criticidad, enUso, incidenciasActivas, tiempoInactivo);
